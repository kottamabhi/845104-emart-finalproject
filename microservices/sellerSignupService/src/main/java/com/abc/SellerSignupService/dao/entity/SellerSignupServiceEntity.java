package com.abc.SellerSignupService.dao.entity;
...
public class SellerSignupServiceEntity {
	...
	public SellerSignupServiceEntity(int sellerId, String sellerUsername, String sellerPassword, String sellerCompany,
	...
	public String toString() {
		return "SellerSignupServiceEntity [sellerId=" + sellerId + ", sellerUsername=" + sellerUsername
				+ ", sellerPassword=" + sellerPassword + ", sellerCompany=" + sellerCompany + ", sellerBrief="
				+ sellerBrief + ", sellerGst=" + sellerGst + ", sellerAddress=" + sellerAddress + ", sellerEmail="
				+ sellerEmail + ", sellerContact=" + sellerContact + ", sellerWebsite=" + sellerWebsite + "]";
	}
